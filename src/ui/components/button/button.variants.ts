...
export const buttonVariants = cva(
    'flex items-center justify-center gap-1 px-3 py-2.5 text-sm rounded-md border leading-none transition-colors duration-300 ease-in-out focus:outline-none cursor-pointer',
    {
        variants: {
            variant: {
                primary:
